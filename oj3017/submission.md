...
```text
โจทย์ให้หาราคารวมทั้งสินที่ลูกค้าต้องจ่าย มี ราคาอาหารและเครื่องดื่ม + ค่าบริการ + vat

Input:
รับราคารวม ค่าอาหารและเครื่องดื่ม

Output:
ราคาทั้งสิ้นที่ลูกค้าต้องจ่าย

Constraints:
Output ต้องการทศนิยม 2 ตำแหน่ง ต้องใช้ fstring :.2f
```
...
```text
Step1 : รับค่าอาหารและเครื่องดื่มรวม
Step2 : หาค่าบริการ 
ถ้า 10%ของราคาอาหารและเครื่องดื่ม น้อยกว่าหรือเท่ากับ 50 บาท คิดค่าบริการ 50
ถ้า 10%ของราคาอาหารและเครื่องดื่ม เกิน 50 แต่ไม่เกิน 1000 ให้คิดค่าบริการตามเปอร์เซ็น
ถ้า 10%ของราคาอาหารและเครื่องดื่ม เท่ากับหรือเกิน 1000 ให้คิดแค่ 1000 เดียว
Step3 : เอาค่าใช้จ่ายรวม + ค่าบริการ ไปหา vat บวกค่า vat เพิ่ม 7%
Step4 : แสดงยอดรวม ค่าอาหารและเครื่องดื่ม + ค่าบริการตามเงื่อนไข + vat 7%
```
...
```text
0 บาท ไม่ได้กินไรเลย มานั่งเฉยๆ
```

...
```text
โจทย์ให้ผสมสีแม่สี รับค่ามา 2 สี แล้วผสม ผสมสีนอกจากแม่สี ขึ้น error

Input:
รับค่าสีแม่สี จำนวน 2 สี

Output:
สี input ผสมสีกันได้อะไร
```
...
Step 2: ผสมสี
Step 3: ผสมสีนอกเหนือจากแม่สี ขึ้น error
Step 4: กรณีสลับสีผสมก่อน หลัง
Step 5: กรณีสีซ้ำ
```
...
```text
เหมือนกับแผนแรก มี 3 กรณี คือ ผสมปกติตามโจทย์ สลับผสมอะไรมาก่อนหลัง ผสมสีเดียวกัน ผสมนอกจากนั้น error
```

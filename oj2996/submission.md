...
```text
โจทย์ให้สลับตัวอักษร โดยรับคำที่มีความยาว 5 ตัวอักษร แล้วให้กลับด้าน

Input:
รับคำภาษาอังกฤษ 5 ตัวอักษร

Output:
ข้อความ input ภาษาอังกฤษ กลับด้าน พิมพ์เล็ก
```
...
```text
Step 1 : คิดก่อน ว่าจะสลับด้านยังไง
Step 2 : ลองใช้ string slicing
Step 3 : ไม่รู้จะทำไง ให้มันวิ่งกลับด้าน
Step 4 : ใช้ string method .lower() ให้พิมพ์เล็กหมด
```
...
```text
ให้ step = -1 มันจะนับจากหลังมาหน้า
```
...
```text
สอนว่า step = -1 มันจะวิ่งกลับหลัง
```

คุณยังทำอะไรด้วยตนเอง

```text
string method .lower() และ string slicing [-1:-5]
```
